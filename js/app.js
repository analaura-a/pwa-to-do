...
function renderTaskLists() {
  ...
  /* Le agregamos a cada lista la función para ver sus tareas */
  arrayTaskLists.forEach((taskList) => {
...
/* Función para ver las tareas (página de detalle) */
function renderTasks(e){
  ...
  // Agregamos contenido de la página de detalle
  appContentContainer.innerHTML += 
  ...
  //Cambiar visibilidad nav

  //Cambiar visibilidad span type
